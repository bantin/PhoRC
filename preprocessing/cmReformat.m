...
psc = zeros(ExpStruct.expParams.repeats*sum(ExpStruct.holoStimParams.nHolos(1,:)),size(draw_dataWinSamplingPnts,2)+99);
psp = zeros(ExpStruct.expParams.repeats*sum(ExpStruct.holoStimParams.nHolos(1,:)),size(draw_dataWinSamplingPnts,2)+99);
...
% save('_cmFormat.mat', 'pscs', 'psps', 'stimulus_matrix', 'targets', 'img', 'pipette_position');
